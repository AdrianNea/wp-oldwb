...
class __TwigTemplate_f2e7a66be6b3984fe4b581c32e6b2c57f6c1e065c0c44b49efb7c81ba239a7f2 extends Twig_Template
{
    ...
    <div class=\"g-panes\">
        ...
        echo "</span>
                    ";
        // line 27
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["particle"] ?? null), "form", array()), "fields", array()), "enabled", array())) {
            // line 28
            echo "                    ";
            $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/menu/particle.html.twig", 28)->display(array_merge($context, array("name" => (($context["prefix"] ?? null) . "enabled"), "field" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["particle"] ?? null), "form", array()), "fields", array()), "enabled", array()), "value" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["item"] ?? null), "options", array()), "particle", array()), "enabled", array()), "default" => 1)));
            // line 29
            echo "                    ";
        }
        // line 30
        echo "                </h4>
                ...
                <div class=\"inner-params\">
                    ";
        // line 33
        $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/menu/particle.html.twig", 33)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["particle"] ?? null), "form", array()), "data" => ($context["data"] ?? null), "prefix" => ($context["prefix"] ?? null), "skip" => array(0 => "enabled"))));
        // line 34
        echo "                </div>
            </div>
        </div>
        ...
        echo "
                ...
                <div class=\"inner-params\">
                    ";
        // line 44
        $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/menu/particle.html.twig", 44)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["block"] ?? null), "form", array()), "data" => $this->getAttribute(($context["item"] ?? null), "options", array()), "prefix" => "block.")));
        // line 45
        echo "                </div>
            </div>
        </div>
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/pages/menu/particle.html.twig", "C:\\Bitnami\\wordpress-4.5.3-0\\apps\\wordpress\\htdocs\\wp-content\\plugins\\gantry5\\admin\\templates\\pages\\menu\\particle.html.twig");
    }
}
